...
// (Esta es tu paleta de colores original)
export const COLORS = {
  ...
  disabled: '#9CA3AF',      // Gris deshabilitado (Tailwind 'gray-400')
};


// --- AÑADIDO: Definiciones de SIZES ---
// Estas son las variables que create-sale.tsx usa para padding, fontSize, etc.
export const SIZES = {
...
// (Aunque create-sale.tsx no usa FONT directamente, lo importa.
// Es buena práctica tenerlo definido para uso futuro).
export const FONT = {
  regular: 'System', // Cambia esto si usas fuentes personalizadas (ej. 'Poppins-Regular')
  medium: 'System',  // (iOS usa 'System-Medium' por defecto)
  bold: 'System',    // (iOS usa 'System-Bold' por defecto)
};